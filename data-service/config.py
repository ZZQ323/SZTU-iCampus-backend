...
MOCK_CONFIG = {
    ...
    "grades_per_major": 4,             # 每专业年级数（2021-2024）
    
    # 人员数据量
    "students_per_class": 50,          # 每班学生数
    "teachers_per_college": 80,        # 每学院教师数（包含副教授以上）
    "staff_per_department": 8,         # 每部门行政人员数
    "admin_total": 20,                 # 管理员总数
    
    # 教师职级分布
    "professor_ratio": 0.15,           # 教授比例
    "associate_professor_ratio": 0.25, # 副教授比例
    "lecturer_ratio": 0.45,           # 讲师比例
    "assistant_ratio": 0.15,          # 助教比例
    
    # 班级管理配置
    "counselor_classes_per_grade": 6,  # 辅导员管理的同年级班级数
    "advisor_classes_per_teacher": 3,  # 班主任管理的跨年级班级数
...
ENCODING_CONFIG = {
    ...
    "college_codes": {
        ...
        "C002": {"name": "数学与统计学院", "code": "MATH", "majors": ["070101", "070102", "071201", "071202", "025200", "071400"]},
        "C003": {"name": "物理与光电工程学院", "code": "PHY", "majors": ["070201", "070202", "080300", "082701", "080700", "080800"]},
        "C004": {"name": "化学与生物工程学院", "code": "CBE", "majors": ["070300", "070400", "071000", "071001", "083001", "081300"]},
        "C005": {"name": "材料科学与工程学院", "code": "MSE", "majors": ["080401", "080402", "080403", "080407", "130508", "082801"]},
        "C006": {"name": "机械设计制造及其自动化学院", "code": "ME", "majors": ["080201", "080202", "080203", "080204", "080301", "120701"]},
        "C007": {"name": "电子与信息工程学院", "code": "EIE", "majors": ["081001", "081002", "081003", "080601", "080701", "080801"]},
        "C008": {"name": "经济管理学院", "code": "EM", "majors": ["120100", "120200", "120300", "120400", "120500", "120600"]},
        "C009": {"name": "外国语学院", "code": "FL", "majors": ["050101", "050102", "050103", "050104", "050105", "050106"]},
        "C010": {"name": "人文社会科学学院", "code": "HSS", "majors": ["030101", "030201", "030301", "060101", "120402", "040101"]},
        "C011": {"name": "艺术设计学院", "code": "AD", "majors": ["130400", "130500", "130300", "130200", "130100", "050300"]},
        "C012": {"name": "医学院", "code": "MED", "majors": ["100201", "100301", "100801", "101001", "101101", "100701"]},
        "C013": {"name": "生命健康学院", "code": "LH", "majors": ["100401", "100501", "100601", "083200", "100901", "120410"]},
    },
