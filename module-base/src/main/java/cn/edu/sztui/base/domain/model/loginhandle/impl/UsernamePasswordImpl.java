...
public class UsernamePasswordImpl implements LoginHandle {
    ...
    public APIResponse loginVerification(BrowserContext context, LoginRequestCommand cmd) {
        ...
        // j_password=P4jOOJfkRL2FFPGJSN7qumx8gpZ1xzAs
        ...
        formData.set("j_password", cmd.getPassword());
        formData.set("j_checkcode", "验证码");
        formData.set("op", "login");
        formData.set("spAuthChainCode", spAuthChainCodePASSWORD);
        ...
        APIResponse ajaxRes = req.post(loginURL+ "?sf_request_type=ajax",
                RequestOptions.create()
                    ...
                    .setHeader("Referer", gatewaySecondEndURL)
